...
def get_args():
    ...
    parser.add_argument(
        "-encoder",
        choices=[
            "Turboae_rate3_rnn",  # TurboAE Encoder, rate 1/3, RNN
    ...
    parser.add_argument(
        "-decoder",
        choices=[
            "TurboAE_rate3_rnn",  # TurboAE Decoder, rate 1/3
    ...
    # Channel parameters
    parser.add_argument(
        "-vv", type=float, default=5, help="only for t distribution channel"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.05,
        help="only for radar distribution channel",
    )
    parser.add_argument(
        "-radar_power",
        type=float,
    ...
    parser.add_argument(
        "-bec_p", type=float, default=0.0, help="only for bec channel, enc"
    )
    parser.add_argument(
        "-bsc_p", type=float, default=0.0, help="only for bsc channel, enc"
    )
    parser.add_argument(
        "-bec_p_dec", type=float, default=0.0, help="only for bec channel, dec"
    )
    parser.add_argument(
        "-bsc_p_dec", type=float, default=0.0, help="only for bsc channel, dec"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="This is CNN number of filters, and RNN units",
    )
    parser.add_argument(
        "-enc_num_unit",
        type=int,
    ...
    parser.add_argument(
        "-enc_act",
        choices=["tanh", "selu", "relu", "elu", "sigmoid", "linear"],
        default="elu",
        help="only elu works",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-num_ber_puncture", type=int, default=5, help="Puncture bad BER positions"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="if 1, joint train enc+dec, 0: seperate train",
    )
    ...
    parser.add_argument(
        "-test_ratio", type=int, default=1, help="only for high SNR testing"
    )
    ...
    parser.add_argument(
        "-img_size", type=int, default=10, help="only used for CNN 2D structures"
    )
    ...
    parser.add_argument(
        "-enc_truncate_limit", type=float, default=0, help="0 means no truncation"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="code: (B, L, R), mode_output (B, L*R/mod_rate, 2)",
    )
    ...
    parser.add_argument(
        "-mod_lr", type=float, default=0.005, help="modulation leanring rate"
    )
    parser.add_argument(
        "-demod_lr", type=float, default=0.005, help="demodulation leanring rate"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=2,
        help="only valid for block_norm_ste",
    )
    parser.add_argument(
        "-enc_value_limit",
        type=float,
    ...
    parser.add_argument(
        "-enc_clipping",
        choices=["inputs", "gradient", "both", "none"],
        default="both",
    ...
    parser.add_argument(
        "-optimizer",
        choices=["adam", "lookahead", "sgd"],
        default="adam",
        help="....:)",
    )
    parser.add_argument(
        "-dec_lr", type=float, default=0.001, help="decoder leanring rate"
    )
    parser.add_argument(
        "-enc_lr", type=float, default=0.001, help="encoder leanring rate"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="default 0.0, the more emphasis on BER loss, only for bce_rl",
    )
    parser.add_argument(
        "-bce_lambda",
        type=float,
        default=1.0,
        help="default 1.0, the more emphasis on BCE loss, only for bce_rl",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="default gamma=0,BCE; 5 is to emphasis wrongly decoded cases.",
    )
    parser.add_argument(
        "-focal_alpha",
        type=float,
        default=1.0,
        help="default alpha=1.0, adjust the loss term",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.01,
        help="add term to maxBCE loss, only wokr with maxBCE loss",
    )
    ...
    parser.add_argument("--save_decoder", action="store_true")
    parser.add_argument("--test_compare_decoder_torch", action="store_true")
    parser.add_argument("--test_compare_encoder_torch", action="store_true")
    parser.add_argument("--test_channel_implementation", action="store_true")
